...
public class ApiClient : MonoBehaviour
{
    ...
    // ---------- ACHIEVEMENTS ----------
    [Serializable] private class UnlockReq { public string achievement_code; } // <-- Cambio aqu�

    public void UnlockAchievement(string achievementCode, Action onSuccess, Action<string> onError)
    {
        // <-- Cambio aqu� abajo tambi�n
    ...
    // ---------- TRANSACTIONS ----------
    [Serializable] private class InitTxReq { public string order_id; public string item_name; public int amount; } // <-- A�adido order_id
    ...
    {
        // Generamos el ID de la orden en el cliente, igual que hac�as antes
    ...
    // OJO: usamos el endpoint VULNERABLE a prop�sito (cliente "ingenuo").
